    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-5">
                ...
                <div class="slogan text-primary-brown fs-4 ">
            ...
            <div class="col-12 col-md-7 ">
                <p class="text-primary-brown fs-4">¡No te pierdas ni un byte! Únete a nuestro newsletter y sé el primero en enterarte de las últimas noticias, tutoriales y cursos del mundo del desarrollo web. ¡Suscríbete ahora y construye el futuro junto a nosotros!</p>
